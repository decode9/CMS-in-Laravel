                ...
                <table id="table_newsletter" class="table table-responsive table-striped table-hover">
                    <thead class="thead-default">
                        <tr>
                            ...
                            <th colspan="1" style="text-align:center; vertical-align:middle;"><button type="button" class="btn btn-default btn-create" value="Go!"><i id="new_icon" class="fa fa-user" aria-hidden="true"> Create Newsletter</i></button></th>
                        </tr>
                        <tr>
